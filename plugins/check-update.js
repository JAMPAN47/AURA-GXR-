...
cmd({
  ...
  try {
    ...
    const rawVersionUrl = 'https://raw.githubusercontent.com//JAMPAN47/AURA-GXR-/main/data/version.json';
    ...
    // GitHub stats
    const githubRepo = 'https://github.com/JAMPAN47/AURA-GXR-';

    // Check update status
    let updateMessage = `✅ Your *AURA-GXR* bot is up-to-date!`;
    if (localVersion !== latestVersion) {
      updateMessage = `🚀 Your *AURA-GXR* bot is outdated!\n🔹 *Current Version:* ${localVersion}\n🔹 *Latest Version:* ${latestVersion}\n\nUse *.update* to update.`;
    }
    ...
    const statusMessage = `🌟 *Good ${new Date().getHours() < 12 ? 'Morning' : 'Evening'}, ${pushname}!* 🌟\n\n` +
      ...
      `📝 *Changelog:*\n${latestChangelog}\n\n` +
      `🌐 *GitHub Repo:* ${githubRepo}\n👤 *Owner:* [Pkdriller](https://github.com/JAMPAN47)\n\n${updateMessage}\n\n🚀 *Don’t forget to star & fork the repo!*`;

    // Send image with status
    await conn.sendMessage(from, {
      image: { url: 'https://files.catbox.moe/gh14e2.jpg' },
      ...
      contextInfo: {
        ...
        forwardedNewsletterMessageInfo: {
          ...
          newsletterName: 'KELVIN Official',
          serverMessageId: 97
        }
      }
    }, { quoted: vcardContact });
